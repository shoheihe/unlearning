...
class ResNet50(nn.Module):
    def __init__(self, filters_percentage=1.0, n_channels=3, num_classes=10, block=Bottleneck, num_blocks=[3, 4, 6, 3]):
...
################################################################
#以上はSCRUBのコードに含まれていたもの、研究室では利ししていない

#以下にAllCNN，PreactResNetのモデル構築コードが存在
