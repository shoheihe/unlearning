seed=(5 6 7 8)
python large_unlearning.py --model 'allcnn' --num-to-forget 8000 --seed 4 --weight-decay 0.0005 --msteps 2 --sgda_epochs 15 --noise-mode sym --delta 250 --zeta 10 --method pro
python large_unlearning.py --model 'allcnn' --num-to-forget 8000 --seed 4 --weight-decay 0.0005 --msteps 2 --sgda_epochs 15 --noise-mode sym --alpha 0 --delta 250 --zeta 10 --method pro
